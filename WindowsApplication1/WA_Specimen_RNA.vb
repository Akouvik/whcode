...
Public Class WA_Specimen_RNA
    ...
    Public Sub New()
        ...
        eqModel.LoadFromStream(_assembly.GetManifestResourceStream("DataWarehouse.modelSpecimen_RNA.xml"))
    End Sub

    Private Sub WA_Specimen_RNA_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        WarehouseShell.highlightSelectedNode("WA_Specimen_RNA")
        Results = New DataTable("Result")
        Reader = New SqlDataAdapter("Select * from viewSpecimen_RNA order by BB asc", WarehouseShell.conn)
        Reader.Fill(Results)
        formatDGV()
