...
Public Class WA_Specimen_DNA
    ...
    Public Sub New()
        ...
        eqModel.LoadFromStream(_assembly.GetManifestResourceStream("DataWarehouse.modelSpecimen_DNA.xml"))
    End Sub

    Private Sub WA_Specimen_DNA_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        WarehouseShell.highlightSelectedNode("WA_Specimen_DNA")
        Results = New DataTable("Result")
        Reader = New SqlDataAdapter("Select * from viewSpecimen_DNA order by BB asc", WarehouseShell.conn)
        Reader.Fill(Results)
        formatDGV()
