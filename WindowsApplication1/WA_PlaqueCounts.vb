Public Class WA_PlaqueCounts
    ...
    'Load form subs
    Private Sub WA_PlaqueCounts_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        WarehouseShell.highlightSelectedNode("WA_PlaqueCounts")
        If Database.ExistingRecordCheck("PlaqueCounts", "SubNum = " & WarehouseShell.SubNum) = True Then
            enableInputFields(False)
            formTables.Tables.Add(Database.ReturnTable("PlaqueCounts", , "SubNum = " & WarehouseShell.SubNum))
            loadExistingData()
            btnPlaqueCountsBottom.Text = "Edit this record"
            btnPlaqueCountsTop.Text = btnPlaqueCountsBottom.Text
            WarehouseShell.DataMode = WarehouseShell.userDataMode.View
        Else
            WarehouseShell.DataMode = WarehouseShell.userDataMode.Undefined
            btnPlaqueCountsBottom.Text = "Add New Record"
            btnPlaqueCountsTop.Text = btnPlaqueCountsBottom.Text
            enableInputFields(False)
    ...
    Private Sub loadExistingData()
        txtField.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("Field").ToString 'string values for text boxes
        txtMFG1.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("MFG1").ToString
        txtMFG2.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("MFG2").ToString
        txtMFG3.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("MFG3").ToString
        txtMFG4.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("MFG4").ToString
        txtMFG5.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("MFG5").ToString
        txtMFG6.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("MFG6").ToString
        txtMFG7.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("MFG7").ToString
        txtMFGAverage.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("MFGAverage").ToString
        txtOFG1.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("OFG1").ToString
        txtOFG2.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("OFG2").ToString
        txtOFG3.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("OFG3").ToString
        txtOFG4.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("OFG4").ToString
        txtOFG5.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("OFG5").ToString
        txtOFG6.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("OFG6").ToString
        txtOFG7.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("OFG7").ToString
        txtOFGAverage.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("OFGAverage").ToString
        txtSTG1.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("STG1").ToString
        txtSTG2.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("STG2").ToString
        txtSTG3.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("STG3").ToString
        txtSTG4.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("STG4").ToString
        txtSTG5.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("STG5").ToString
        txtSTG6.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("STG6").ToString
        txtSTG7.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("STG7").ToString
        txtSTGAverage.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("STGAverage").ToString
        txtIPL1.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("IPL1").ToString
        txtIPL2.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("IPL2").ToString
        txtIPL3.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("IPL3").ToString
        txtIPL4.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("IPL4").ToString
        txtIPL5.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("IPL5").ToString
        txtIPL6.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("IPL6").ToString
        txtIPL7.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("IPL7").ToString
        txtIPLAverage.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("IPLAverage").ToString
        txtOC1.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("OC1").ToString
        txtOC2.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("OC2").ToString
        txtOC3.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("OC3").ToString
        txtOC4.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("OC4").ToString
        txtOC5.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("OC5").ToString
        txtOC6.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("OC6").ToString
        txtOC7.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("OC7").ToString
        txtOCAverage.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("OCAverage").ToString
        txtHippo1.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("Hippo1").ToString
        txtHippo2.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("Hippo2").ToString
        txtHippo3.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("Hippo3").ToString
        txtHippo4.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("Hippo4").ToString
        txtHippo5.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("Hippo5").ToString
        txtHippo6.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("Hippo6").ToString
        txtHippo7.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("Hippo7").ToString
        txtHippoAverage.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("HippoAverage").ToString
        txtEntCtx1.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("EntCtx1").ToString
        txtEntCtx2.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("EntCtx2").ToString
        txtEntCtx3.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("EntCtx3").ToString
        txtEntCtx4.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("EntCtx4").ToString
        txtEntCtx5.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("EntCtx5").ToString
        txtEntCtx6.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("EntCtx6").ToString
        txtEntCtx7.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("EntCtx7").ToString
        txtEntCtxAverage.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("EntCtxAverage").ToString
        txtMean.Text = formTables.Tables("PlaqueCounts").Rows(0).Item("Mean").ToString
    End Sub
    ...
    End Sub
    Private Sub MFGAVG()
        Dim Sum As Double = IIf(IsNumeric(txtMFG1.Text), Val(txtMFG1.Text), 0) + IIf(IsNumeric(txtMFG2.Text), Val(txtMFG2.Text), 0) + IIf(IsNumeric(txtMFG3.Text), Val(txtMFG3.Text), 0) + IIf(IsNumeric(txtMFG4.Text), Val(txtMFG4.Text), 0) + IIf(IsNumeric(txtMFG5.Text), Val(txtMFG5.Text), 0) + IIf(IsNumeric(txtMFG6.Text), Val(txtMFG6.Text), 0) + IIf(IsNumeric(txtMFG7.Text), Val(txtMFG7.Text), 0)
    ...
    Private Sub btnPlaqueCounts_Click(sender As Object, e As EventArgs) Handles btnPlaqueCountsBottom.Click, btnPlaqueCountsTop.Click
        If WarehouseShell.DataMode = WarehouseShell.userDataMode.View Then
            If User.PermissionCheck("WA_PlaqueCounts", "Modify") Then
                WarehouseShell.DataMode = WarehouseShell.userDataMode.Edit
                enableInputFields(True)
                btnPlaqueCountsBottom.Text = "Save changes"
                btnPlaqueCountsTop.Text = btnPlaqueCountsBottom.Text
            End If
        ElseIf WarehouseShell.DataMode = WarehouseShell.userDataMode.Undefined Then
            If User.PermissionCheck("WA_PlaqueCounts", "Modify") Then
                ...
                enableInputFields(True)
                btnPlaqueCountsBottom.Text = "Save new record"
                btnPlaqueCountsTop.Text = btnPlaqueCountsBottom.Text
        ...
        Else
            ...
            If WarehouseShell.DataMode = WarehouseShell.userDataMode.Insert Then
                sqlCommand.CommandText = "EXEC dbo.modPlaqueCountsRecord @Action = 1, " & cmdString
                Try
                ...
                End Try
            Else
                sqlCommand.CommandText = "EXEC dbo.modPlaqueCountsRecord @Action = 2, " & cmdString
                Try
                    sqlCommand.ExecuteNonQuery()
    ...
    Public Sub SaveWork() Implements IFormMethods.SaveWork
        btnPlaqueCountsBottom.PerformClick()
    End Sub
